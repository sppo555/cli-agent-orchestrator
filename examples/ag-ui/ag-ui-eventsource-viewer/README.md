...
#   then open: http://localhost:8000/examples/ag-ui/ag-ui-eventsource-viewer/
...
the animated GIF (`docs/media/ag-ui-eventsource-viewer-demo.gif`) is the byproduct, exported
...
npm run record   # -> docs/media/ag-ui-eventsource-viewer-demo.gif (+ .webm)
```
