...
//
// Artifacts (docs/media/): ag-ui-eventsource-viewer-demo.webm and
// ag-ui-eventsource-viewer-demo.gif (when a gif-capable ffmpeg is found).
//
...
const VIEWER_URL = `http://localhost:${STATIC_PORT}/examples/ag-ui/ag-ui-eventsource-viewer/`;
...
async function main() {
  ...
  try {
    ...
    const outWebm = resolve(OUT_DIR, "ag-ui-eventsource-viewer-demo.webm");
    ...
    const outGif = resolve(OUT_DIR, "ag-ui-eventsource-viewer-demo.gif");
