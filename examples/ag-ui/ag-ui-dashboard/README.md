...
![AG-UI EventSource viewer rendering the six generative-UI components live](../../../docs/media/ag-ui-eventsource-viewer-demo.gif)

For a rendered view instead of raw frames, open the **dependency-free
EventSource viewer** in [`../ag-ui-eventsource-viewer/`](../ag-ui-eventsource-viewer/):
...
```sh
python3 -m http.server 8000   # then open http://localhost:8000/examples/ag-ui/ag-ui-eventsource-viewer/
```

See [`../ag-ui-eventsource-viewer/README.md`](../ag-ui-eventsource-viewer/README.md)
